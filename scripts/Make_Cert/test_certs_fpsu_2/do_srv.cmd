C:\OpenSSL\bin\openssl.exe genrsa -out 1_test_server.key 2048

C:\OpenSSL\bin\openssl.exe req -new -nodes -keyout 1_test_server.key -out 1_test_server.csr -days 3650 -config ssl1.conf
...
C:\OpenSSL\bin\openssl.exe pkcs12 -export -certpbe PBE-SHA1-3DES -keypbe PBE-SHA1-3DES -macalg SHA1 -inkey Server22_FPSU.key -in CA_cert.pem -in Server22_FPSU.crt -passout pass:1234 -name "Server22_FPSU" -out Server22_FPSU.pfx

C:\OpenSSL\bin\openssl.exe pkcs12 -export -certpbe PBE-SHA1-3DES -keypbe PBE-SHA1-3DES -macalg SHA1 -inkey 1_test_client.key -in 1_test_client.crt -passout pass:1234 -name "1_test_client" -out 1_test_client.pfx
